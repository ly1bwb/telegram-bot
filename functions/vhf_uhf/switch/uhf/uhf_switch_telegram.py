...
async def set_uhf_sdr_switch_state(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    log.info(
...
async def read_uhf_sdr_switch_state(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
